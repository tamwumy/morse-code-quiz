...
function ModeButton({ active, onClick, children }) {
    return (
        <button
            onClick={onClick}
            className={`px-3 py-2 rounded-xl text-sm font-mono border transition active:scale-[.98] shadow-sm ${active
            ...
            <div className="max-w-3xl mx-auto px-4 py-8">
                ...
                <div className="bg-black border border-white/20 rounded-2xl shadow-sm p-5">
                    ...
                    <input
                        ...
                        className={`w-full rounded-xl border px-3 py-2 font-medium focus:outline-none focus:ring-2 transition ${feedback === "correct" ? "border-white ring-white/40" : feedback === "wrong" ? "border-white ring-white/40" : "border-white/30 focus:ring-white/30"
                            } bg-black text-white`}
                        onKeyDown={(e) => {
